...
class SUN(Dataset):
    ...
    num_classes: 40
    """
    CLASSES = ['Background','wall','floor','cabinet','bed','chair','sofa','table','door','window','bookshelf','picture','counter','blinds',
    'desk','shelves','curtain','dresser','pillow','mirror','floor mat','clothes','ceiling','books','fridge',
    'tv','paper','towel','shower curtain','box','whiteboard','person','night stand','toilet',
    'sink','lamp','bathtub','bag']

    PALETTE = None

    def __init__(self, root: str = 'data/SUN', split: str = 'train', transform = None, modals = ['img', 'depth'], case = None) -> None:
        super().__init__()
